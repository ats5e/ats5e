...
const SOLUTIONS: Record<string, {
  ...
  "Data-Infrastructure-Governance": {
    num: "01", title: "Data Infrastructure & Governance",
  ...
  "AI-intelligence": {
    num: "02", title: "AI-Powered Decision Intelligence",
  ...
  "Legacy-Modernisation": {
    num: "03", title: "Legacy Modernisation & Cloud Evolution",
  ...
  "Intelligent-Automation": {
    num: "04", title: "Intelligent Automation & Agentic AI",
  ...
  "ConversationalAI": {
    num: "05", title: "Conversational AI & Digital Assistants",
  ...
  "compliance-risk": {
    num: "06", title: "Compliance, Risk & Fraud Intelligence",
  ...
  "Credit-Risk": {
    num: "07", title: "Credit Risk & Underwriting Intelligence",
  ...
  "Treasury-Liquidity": {
    num: "08", title: "Treasury & Liquidity Intelligence",
  ...
  "Human-Centred-Digital-Experience": {
    num: "09", title: "Human-Centred Digital Experience",
  ...
  "transformation-execution": {
    num: "10", title: "End-to-End Transformation Execution",
  ...
  "Enterprise-Integration": {
    num: "11", title: "Enterprise Integration & Workflow",
  ...
  "education": {
    num: "12", title: "Tailored Education Solutions",
    ...
    <div className="min-h-screen bg-[#050505] text-white overflow-x-hidden">
      ...
      <section className="relative pt-44 pb-20 px-6">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg font-medium text-zinc-400 max-w-2xl leading-relaxed">{s.tagline}</p>
        </div>
      </section>
      ...
      <section className="py-16 px-6 pb-32">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="md:col-span-2">
            <h2 className="text-2xl font-black uppercase tracking-[-0.03em] mb-8">{s.detailsTitle}</h2>
