...
export default function SolutionsClient({ initialSolutions }: { initialSolutions: CmsSolution[] | null }) {
  const [solutions, setSolutions] = React.useState<SolutionSummary[]>(() =>
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div custom={3} variants={fadeUp} initial="hidden" animate="visible" className="relative w-full aspect-square lg:aspect-[4/3] rounded-3xl overflow-hidden hidden md:block" style={{ border: "1px solid rgba(255,255,255,0.06)" }}>
              <Image src="/imagery/colorful-abstract-silhouette.webp" alt="Colorful Abstract Silhouette" fill className="object-cover" priority />
          ...
          >
            ...
            <div className="flex-shrink-0 w-full md:w-[40%] xl:w-[45%] relative z-10 hidden md:block">
               <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl" style={{ border: "1px solid rgba(255,255,255,0.08)" }}>
                  <Image src="/imagery/digital-maze-exploration.webp" alt="EduFlow Innovation" fill className="object-cover" />
                  <div className="absolute inset-0 bg-[#050505] opacity-20" />
            ...
            return (
              <React.Fragment key={s.num}>
                {i === 2 && (
                  ...
                  >
                    <Image src="/imagery/vibrant-silhouettes.webp" alt="Vibrant Silhouettes" fill className="object-cover" />
                    <div className="absolute inset-0 bg-[#050505] opacity-20" />
