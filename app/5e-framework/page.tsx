      ...
      <section className="relative pt-44 pb-20 px-6">
        ...
        <div className="max-w-7xl mx-auto">
          <motion.div custom={0} variants={fadeUp} initial="hidden" animate="visible">
            <span className="text-[10px] tracking-[0.35em] uppercase text-zinc-600 font-medium block mb-6">Core Framework</span>
          </motion.div>
            ...
            >
              ...
              >
                <div className="shrink-0 flex items-center gap-6">
                  <span className="text-[10px] tracking-[0.28em] uppercase font-medium text-zinc-700 group-hover:text-[#148be6] transition-colors w-6">{e.number}</span>
