...
const TEAM_MEMBERS = [
  ...
  { name: "Kumar Jaisingh", role: "Chief Product & Delivery Officer", bio: "Kumar leads product strategy and execution, bringing 28 years of experience bridging high-level strategy with on-the-ground delivery. Specializing in Banking and Digital Ecosystems across the UAE and KSA, he has partnered with top-tier consultancies like McKinsey and Deloitte.", photoUrl: "/Headshots (New)/Kumar Headshot.webp", displayOrder: 2 },
  { name: "Gaurav Diwan", role: "Chief Technology Officer", bio: "Gaurav leads the design and execution of enterprise-scale transformation for the financial services sector. With over 28 years of experience at global institutions like Barclays, Oracle, and ADCB, he specializes in applying Cloud, AI, and ML to de-risk transformation and build superior customer experiences.", photoUrl: "/Headshots (New)/Gaurav headshot.webp", displayOrder: 3 },
  { name: "Jack Donaldson", role: "Head of Marketing & Communications", bio: "A dynamic marketing and communications leader with a proven record of driving brand growth, elevating storytelling, and delivering measurable results across global markets. Experience spanning London, New York, and Sydney — blending creative vision with commercial precision for the world's leading banks and fintechs.", photoUrl: "/Headshots (New)/Jack Headshot.webp", displayOrder: 4 },
  { name: "Sophia Knight", role: "Business Development Executive", bio: "Sophia brings a sharp commercial instinct and a proven talent for building trust-based relationships across competitive, fast-moving markets. Sophia leads business development with a focus on forging high-value partnerships and building scalable sales channels that connect the right organisations with the firm's enterprise transformation and AI capabilities across the GCC.", photoUrl: "/Headshots (New)/Sophia Headshot.webp", displayOrder: 5 },
  { name: "Ayesha Azhar", role: "Head of Operations", bio: "Brings over four years of experience establishing and managing best-in-class Project Management Offices, with a focus on quality assurance, governance, and stakeholder reporting. Her portfolio spans a global real estate firm, a government entity, and a MENA fintech start-up.", photoUrl: "/Headshots (New)/Ayesha Headshot.webp", displayOrder: 6 },
];
